        ...
        <div className="flex flex-col gap-4 lg:w-[45%] w-full">
          ...
          <div data-aos="fade-up" className="">
            ...
            <p className="text-desc">
              At [your company name], we craft innovative, AI-driven technology
              solutions to help businesses overcome challenges, achieve
              excellence, and unlock sustainable growth in the digital age.
            </p>
          </div>
